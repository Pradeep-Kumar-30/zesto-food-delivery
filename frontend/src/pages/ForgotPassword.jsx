...
const [loading,setLoading]=useState(false)
  ...
  return (
    <div className='flex w-full items-center justify-center min-h-screen p-4 bg-gradient-to-br from-slate-50 via-violet-50 to-cyan-50'>
      <div className='bg-white rounded-xl shadow-lg w-full max-w-md p-8'>
        <div className='flex items-center  gap-4 mb-4'>
          <IoIosArrowRoundBack size={30} className='text-[#6d28d9] cursor-pointer' onClick={()=>navigate("/signin")}/>
          <h1 className='text-2xl font-bold text-center text-[#6d28d9]'>Forgot Password</h1>
        </div>
        {step == 1
          &&
          <div>
 <div className='mb-6'>
                ...
                <button className={`w-full font-semibold py-2 rounded-lg transition duration-200 bg-[#6d28d9] text-white hover:bg-[#5b21b6] cursor-pointer`} onClick={handleSendOtp} disabled={loading}>
                {loading?<ClipLoader size={20} color='white'/>:"Send Otp"}
            </button>
                 {err && <p className='text-fuchsia-600 text-center my-[10px]'>*{err}</p>}
          </div>}
 ...
 <div className='mb-6'>
                ...
                <button className={`w-full font-semibold py-2 rounded-lg transition duration-200 bg-[#6d28d9] text-white hover:bg-[#5b21b6] cursor-pointer`} onClick={handleVerifyOtp} disabled={loading}>
 ...
 <div className='mb-6'>
                ...
                <button className={`w-full font-semibold py-2 rounded-lg transition duration-200 bg-[#6d28d9] text-white hover:bg-[#5b21b6] cursor-pointer`} onClick={handleResetPassword} disabled={loading}>
